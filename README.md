...
## 성장점
### 기술적 성장
- 프로젝트를 진행하며 **Java와 Spring Boot**에 대한 이해도 향상
- AWS **Lightsail에 Ubuntu 환경을 구성**하고, Oracle 데이터베이스 설치 및 Spring Boot 애플리케이션을 **직접 배포**함으로써 **클라우드 기반 서비스 운영 경험**을 쌓을 수 있었습니다.
